...
export interface Texture {
    ...
    width: number;
    height: number;
    loadFromFile(path: string, filter?: TextureFilter): void;
    loadFromMemoryRGBA32(width: number, height: number, data: Buffer, filter?: TextureFilter): void;
    isValid(): boolean;
}
export interface Font {
    ...
    renderText(str: string, fgcol: vec4, bgcol: vec4, filter?: TextureFilter): Texture;
}
export declare const enum FlipFlags {
    None = 0,
    Horizontal = 1,
    Vertical = 2
}
